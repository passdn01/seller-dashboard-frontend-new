...
//     const [allTimeConversionRate, setAllTimeConversionRate] = useState(0);
//     const [todayConversionRate, setTodayConversionRate] = useState(0);


//     const calculateConversionRate = (completed, searched) => {
//         if (!searched || searched === 0) return 0;
//         console.log("Completed:", completed, "Searched:", searched);
//         const completedNum = parseFloat(completed) || 0;
//         const searchedNum = parseFloat(searched) || 0;
//         console.log((completedNum / searchedNum) * 100, "calculateConversionRate")
//         return (completedNum / searchedNum) * 100;
//     };

//     const d = [{
//         group: 'Search/Completed Ride Ratio',
//         value: allTimeConversionRate
//     }];
...
//             setAllTimeConversionRate(
//                 calculateConversionRate(
//                     data.allTimeMetrics?.completedRides,
//                     data.allTimeMetrics?.SearchRides
//                 )
//             );
//             setTodayConversionRate(
//                 calculateConversionRate(
//                     data.todayMetrics?.completedRides || 0,
//                     data.todayMetrics?.SearchRides || 0
//                 )
//             );
//         };
...
//             title: "KM We Serve",
//             increase: formatNumber(lastHourMetrics.kmServed),
//             hover: true,
//             hoverData: {
...
//             title: "KM We Serve",
//             increase: formatNumber(todayMetrics.kmServed),
//             hover: true,
//             hoverData: {
//                 title: "Kilometers Served",
...
//         {
//             icon: drivers,
//             number: formatNumber(allTimeMetrics.verifiedDrivers || 0),
//             title: "Verified Drivers",
//             increase: todayMetrics.verifiedDrivers,
//             hover: false,
//         },
//     ];

//     // console.log(allTimeMetrics, "alltime")
//     // console.log(todayMetrics, "today ")
...
export default function CardGrid() {
    ...
    const d = [{
        group: 'Search/Completed Ride Ratio',
        value: (allTimeMetrics.SearchRides != 0 ? allTimeMetrics.completedRides * 100 / allTimeMetrics.SearchRides : 0) || 0
    }]
    const dToday = [{
        group: 'Search/Completed Ride Ratio',
    ...
    const todayTabData = [
        ...
        },
        {
            ...
            number: formatNumber(todayMetrics.kmServed || 0),
            title: "KM We Serve",
            increase: formatNumber(lastHourMetrics.kmServed || 0),
            hover: true,
            hoverData: {
                title: "Kilometers Served",
                lastHourNumber: lastHourMetrics.kmServed,
