            ...
            <div className="p-6">
                ...
                <div className="flex items-center gap-4 mb-6">
                    ...
                    <div className="flex items-center gap-2 bg-gray-100 rounded-lg p-1">
                        ...
                        <button
                            className={`px-4 py-2 rounded-md text-sm transition-colors ${activeTab === 'custom'
                                ? 'bg-blue-500 text-white shadow-sm'
                                : 'text-gray-500 hover:text-gray-700'
                                }`}
                            onClick={() => {
                ...
                {activeTab === 'today'
                    ? displayData(todayTabData)
                    : activeTab === 'yesterday'
                        ? displayData(yesterdayTabData)
                        : activeTab === "allTime"
                            ? displayData(allTimeTabData)
                            : <CustomTimeCardGrid />
                }
                ...
                {activeTab === 'today'
                    ? <div className='p-2 border-2 border-gray-100 m-6 rounded '><MeterChart data={dToday} options={op}></MeterChart> </div>
                    : activeTab === 'yesterday'
                        ? <div className='p-2 border-2 border-gray-100 m-6 rounded '><MeterChart data={dYesterday} options={op}></MeterChart> </div>
                        : activeTab === 'allTime' ? <div className='p-2 border-2 border-gray-100 m-6 rounded '><MeterChart data={d} options={op}></MeterChart>  </div> : <div></div>}
