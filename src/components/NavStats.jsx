...
const NavStats = () => {
    ...
    const fetchTotalCompletedRides = async () => {
        try {
            const response = await axios.post('https://f6vfh6rc-2003.inc1.devtunnels.ms/dashboard/api/totalStatsData', { period: 'all time' });
    ...
    const fetchOnlineDrivers = async () => {
        try {
            const response = await axios.post('https://f6vfh6rc-2003.inc1.devtunnels.ms/dashboard/api/online-drivers');
    ...
    const fetchOngoingRides = async () => {
        try {
            const response = await axios.get('https://f6vfh6rc-2003.inc1.devtunnels.ms/dashboard/api/total-ongoing-rides');
