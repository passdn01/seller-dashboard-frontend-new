...
const GeoMetrics = () => {
    ...
    const fetchRideDistribution = () => {
        axios.get('https://f6vfh6rc-2003.inc1.devtunnels.ms/dashboard/api/ride-distribution')
            .then(response => {
    ...
    const fetchCancelledRideDistribution = () => {
        axios.get('https://f6vfh6rc-2003.inc1.devtunnels.ms/dashboard/api/cancelled-ride-distribution')
            .then(response => {
                const data = response.data.map(cluster => [
                    cluster.center.lat,
                    cluster.center.lng,
    ...
    const fetchDriverLocations = () => {
        axios.get('https://f6vfh6rc-2003.inc1.devtunnels.ms/dashboard/api/online-drivers')
            .then(response => {
