...
export default function DriverTable() {
    ...
    const handleDelete = async () => {
        ...
        try {
            ...
            if (response.data.success) {
                ...
                const newResponse = await axios.post(`${SELLER_URL_LOCAL}/dashboard/api/allDrivers`);
    ...
    const handleStatusUpdate = async (driverId, currentStatus) => {
        try {
            await axios.post(`${SELLER_URL_LOCAL}/dashboard/api/driver/${driverId}/completeEdit`, {
